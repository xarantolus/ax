...
impl Axecutor {
    pub fn mnemonic_idiv(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        match i.code() {
            ...
            _ => panic!("Invalid instruction code {:?} for mnemonic Idiv", i.code()),
        }
    }
    ...
    fn instr_idiv_rm8(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        let src_val = match op {
            ...
            _ => panic!("Invalid operand {:?} for Idiv_rm8", op),
        } as i16;
    ...
    fn instr_idiv_rm16(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        let src_val = match op {
            ...
            _ => panic!("Invalid operand {:?} for Idiv_rm16", op),
        } as i32;
        ...
        let dst_val = (self.reg_read_16(AX) as u32 | ((self.reg_read_16(DX) as u32) << 16)) as i32;
    ...
    fn instr_idiv_rm32(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        let src_val = match op {
            ...
            _ => panic!("Invalid operand {:?} for Idiv_rm32", op),
        } as i64;
    ...
    fn instr_idiv_rm64(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        let src_val = match op {
            ...
            _ => panic!("Invalid operand {:?} for Idiv_rm64", op),
        } as u128 as i128;
