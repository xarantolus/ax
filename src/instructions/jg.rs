...
impl Axecutor {
    pub fn mnemonic_jg(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        match i.code() {
            ...
            _ => panic!("Invalid instruction code {:?} for mnemonic Jg", i.code()),
        }
    }
    ...
    fn instr_jg_rel8_64(&mut self, i: Instruction) -> Result<(), AxError> {
            ...
            && (self.state.rflags & FLAG_SF == 0) == (self.state.rflags & FLAG_OF == 0)
        {
            match i.op0_kind() {
                ...
                _ => panic!("Invalid op0_kind {:?} for JG rel8_64", i.op0_kind()),
            }
        }
    ...
    fn instr_jg_rel32_64(&mut self, i: Instruction) -> Result<(), AxError> {
            ...
            && (self.state.rflags & FLAG_SF == 0) == (self.state.rflags & FLAG_OF == 0)
        {
            match i.op0_kind() {
                ...
                _ => panic!("Invalid op0_kind {:?} for JG rel32_64", i.op0_kind()),
            }
        }
