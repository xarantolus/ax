...
mod tests {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_11_53; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            a.mem_write_128(0x1000, 0x400000000000u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_48_26; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x8000000000000u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_95_53_46; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x1f9d734e551fcda8eb6d1f6a96a4c214u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_88_79_96; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x3fu128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_87_21; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x20000000000u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_17_58; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x80000u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_96_9; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x800000u128).unwrap();
        };
        |a: Axecutor| {
    ...
    ax_test![xorps_xmm0_xmmword_ptr_rbx_4_20; 0xf, 0x57, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            a.mem_init_zero(0x1000, 16).unwrap();
            a.mem_write_128(0x1000, 0x964b401d4fe1f0707737810d2358ffb2u128).unwrap();
        };
        |a: Axecutor| {
