...
mod tests {
    ...
    ax_test![mov_byte_ptr_rsp8_bl; 0x88, 0x5c, 0x24, 0x8;
        ...
        |a: Axecutor| {
            ...
            assert_eq!(a.mem_read_8(0x1008).unwrap(), 0x12);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_word_ptr_rsp8_r11w; 0x66, 0x44, 0x89, 0x5c, 0x24, 0x8;
        ...
        |a: Axecutor| {
            ...
            assert_eq!(a.mem_read_16(0x1008).unwrap(), 0x1234);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_dword_ptr_rsp_edx; 0x89, 0x14, 0x24;
        ...
        |a: Axecutor| {
            ...
            assert_eq!(a.mem_read_32(0x1000).unwrap(), 0x12345678);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_qword_ptr_rsp_rcx; 0x48, 0x89, 0xc, 0x24;
        ...
        |a: Axecutor| {
            ...
            assert_eq!(a.mem_read_64(0x1000).unwrap(), 0x123456789abcdef0u64);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_bl_rsp; 0x8a, 0x1c, 0x24;
        ...
        |a: Axecutor| {
            assert_reg_value!(b; a; BL; 0x12);
            assert_eq!(a.mem_read_8(0x1000).unwrap(), 0x12);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_cx_rsp; 0x66, 0x8b, 0xc, 0x24;
        ...
        |a: Axecutor| {
            ...
            assert_eq!(a.mem_read_16(0x1000).unwrap(), 0x5678);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_byte_ptr_rsp_0x15; 0xc6, 0x4, 0x24, 0x15;
        ...
        |a: Axecutor| {
            assert_eq!(a.mem_read_8(0x1000).unwrap(), 0x15);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_word_ptr_rsp_0x15; 0x66, 0xc7, 0x4, 0x24, 0x15, 0x0;
        ...
        |a: Axecutor| {
            assert_eq!(a.mem_read_16(0x1000).unwrap(), 0x15);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_dword_ptr_rsp_0x31535135; 0xc7, 0x4, 0x24, 0x35, 0x51, 0x53, 0x31;
        ...
        |a: Axecutor| {
            assert_eq!(a.mem_read_32(0x1000).unwrap(), 0x31535135);
        };
        (0; FLAGS_UNAFFECTED)
    ];
    ...
    ax_test![mov_qword_ptr_rsp_0xfffffffffffff135_sign_extension; 0x48, 0xc7, 0x4, 0x24, 0x35, 0xf1, 0xff, 0xff;
        ...
        |a: Axecutor| {
            assert_eq!(a.mem_read_64(0x1000).unwrap(), 0xfffffffffffff135u64);
        };
        (0; FLAGS_UNAFFECTED)
    ];
}
