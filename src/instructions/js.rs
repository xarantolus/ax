...
impl Axecutor {
    pub fn mnemonic_js(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        match i.code() {
            ...
            _ => panic!("Invalid instruction code {:?} for mnemonic Js", i.code()),
        }
    }
    ...
    fn instr_js_rel8_64(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        if self.state.rflags & FLAG_SF != 0 {
            match i.op0_kind() {
                ...
                _ => panic!("Invalid op0_kind {:?} for JS rel8_64", i.op0_kind()),
            }
        }
    ...
    fn instr_js_rel32_64(&mut self, i: Instruction) -> Result<(), AxError> {
        ...
        if self.state.rflags & FLAG_SF != 0 {
            match i.op0_kind() {
                ...
                _ => panic!("Invalid op0_kind {:?} for JS rel32_64", i.op0_kind()),
            }
        }
