...
impl Axecutor {
    pub(crate) fn mnemonic_sub(&mut self, i: Instruction) -> Result<(), AxError> {
...
mod tests {
    ...
    ax_test![sub_qword_ptr_rbx_rax_af; 0x48, 0x29, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x10);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(q; a; 0x1000; 0x6e32b5e7052bfca1u64);
        };
        (FLAG_CF; FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_af; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(q; a; 0x1000; 0x255a49b3cfd9dcdfu64);
        };
        (FLAG_CF; FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_pf; 0x48, 0x29, 0x3;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x3f);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0xbe2001ffcd2422c7u64);
            assert_mem_value!(q; a; 0x1000; 0x41dffe0032dbdd78u64);
        };
        (FLAG_CF | FLAG_PF; FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_pf_af; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(q; a; 0x1000; 0x57288fdf7a609e71u64);
        };
        (FLAG_CF | FLAG_PF; FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_pf_sf; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(q; a; 0x1000; 0xfffffffffffffff0u64);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_sf; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(q; a; 0x1000; 0xffffffffffffffe0u64);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_cf_sf_af; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x8);
            assert_mem_value!(q; a; 0x1000; 0xfffffffffffffff8u64);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rbx_rax_pf; 0x48, 0x29, 0x3;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1);
            assert_mem_value!(q; a; 0x1000; 0x6);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_al_byte_ptr_rbx_cf_pf_sf; 0x2a, 0x3;
        |a: &mut Axecutor| {
            write_reg_value!(b; a; AL; 0x0);
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(b; a; 0x1000; 0x10);
        };
        |a: Axecutor| {
            assert_reg_value!(b; a; AL; 0xf0);
    ...
    ax_test![sub_al_byte_ptr_rbx_cf_sf; 0x2a, 0x3;
        |a: &mut Axecutor| {
            write_reg_value!(b; a; AL; 0x0);
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(b; a; 0x1000; 0x20);
        };
        |a: Axecutor| {
            assert_reg_value!(b; a; AL; 0xe0);
    ...
    ax_test![sub_ecx_dword_ptr_rbx_cf_pf_sf; 0x2b, 0xb;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(d; a; 0x1000; 0x10);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_ecx_dword_ptr_rbx_cf_sf; 0x2b, 0xb;
        |a: &mut Axecutor| {
            write_reg_value!(d; a; ECX; 0x0);
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(d; a; 0x1000; 0x20);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_r11_qword_ptr_rbx_cf_sf; 0x4c, 0x2b, 0x1b;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; R11; 0x0);
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x20);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_r11_qword_ptr_rbx_pf_sf_af; 0x4c, 0x2b, 0x1b;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x1f);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_r11_qword_ptr_rbx_sf_af; 0x4c, 0x2b, 0x1b;
        |a: &mut Axecutor| {
            ...
            write_reg_value!(q; a; RBX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x7f);
        };
        |a: Axecutor| {
    ...
    ax_test![sub_word_ptr_rax_0x31; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            ...
            assert_mem_value!(w; a; 0x1000; 0xe);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_af; 0x66, 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(w; a; 0x1000; 0x80);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0x4f);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_cf_pf_sf; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0xffd7);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_cf_pf_sf_af; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0xffcf);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_cf_sf; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0xffd0);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_cf_sf_af; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0xffdf);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_pf; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0x4e);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_pf_af; 0x66, 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(w; a; 0x1000; 0x40);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
    ...
    ax_test![sub_word_ptr_rax_0x31_pf_of_af; 0x66, 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0x7fcf);
        };
        (FLAG_PF | FLAG_OF; FLAG_CF | FLAG_ZF | FLAG_SF)
    ];
    ...
    ax_test![sub_word_ptr_rax_0x31_pf_zf; 0x66, 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(w; a; 0x1000; 0x31);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0x0);
    ...
    ax_test![sub_dword_ptr_rax_0x31; 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(d; a; 0x1000; 0x3f);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0xe);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_af; 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(d; a; 0x1000; 0x80);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0x4f);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_cf_pf_sf; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0xffffffd7u32);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_cf_pf_sf_af; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0xffffffcfu32);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_cf_sf; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0xffffffd0u32);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_cf_sf_af; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0xffffffdfu32);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_pf; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0x4e);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_pf_of_af; 0x83, 0x28, 0x31;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0x7fffffcf);
        };
        (FLAG_PF | FLAG_OF; FLAG_CF | FLAG_ZF | FLAG_SF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x31_pf_zf; 0x83, 0x28, 0x31;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(d; a; 0x1000; 0x31);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0x0);
    ...
    ax_test![sub_qword_ptr_rax_0x35; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0x4a);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_af; 0x48, 0x83, 0x28, 0x35;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x40);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xb);
        };
        (0; FLAG_CF | FLAG_PF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_cf_pf_sf; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xffffffffffffffd2u64);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_cf_pf_sf_af; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xffffffffffffffccu64);
        };
        (FLAG_CF | FLAG_PF | FLAG_SF; FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_cf_sf; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xffffffffffffffd3u64);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_cf_sf_af; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xffffffffffffffcbu64);
        };
        (FLAG_CF | FLAG_SF; FLAG_PF | FLAG_ZF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_pf; 0x48, 0x83, 0x28, 0x35;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xa);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_pf_af; 0x48, 0x83, 0x28, 0x35;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x41);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0xc);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x35_pf_zf; 0x48, 0x83, 0x28, 0x35;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x35);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0x0);
    ...
    ax_test![sub_word_ptr_rax_0x13b_pf_of_af; 0x66, 0x81, 0x28, 0x3b, 0x1;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(w; a; 0x1000; 0x7ec5);
        };
        (FLAG_PF | FLAG_OF; FLAG_CF | FLAG_ZF | FLAG_SF)
    ];
    ...
    ax_test![sub_dword_ptr_rax_0x4c8ab_pf_of_af; 0x81, 0x28, 0xab, 0xc8, 0x4, 0x0;
        ...
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(d; a; 0x1000; 0x7ffb3755);
        };
        (FLAG_PF | FLAG_OF; FLAG_CF | FLAG_ZF | FLAG_SF)
    ];
    ...
    ax_test![sub_qword_ptr_rax_0x1de62ef_pf_af; 0x48, 0x81, 0x28, 0xef, 0x62, 0xde, 0x1;
        |a: &mut Axecutor| {
            write_reg_value!(q; a; RAX; 0x1000);
            init_mem_value!(q; a; 0x1000; 0x2000000);
        };
        |a: Axecutor| {
            assert_reg_value!(q; a; RAX; 0x1000);
            assert_mem_value!(q; a; 0x1000; 0x219d11);
        };
        (FLAG_PF; FLAG_CF | FLAG_ZF | FLAG_SF | FLAG_OF)
    ];
}
